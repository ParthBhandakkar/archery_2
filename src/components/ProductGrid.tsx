...
const products = [
  ...
  {
    id: 4,
    name: 'Premium Archery Target',
    price: 129.99,
    image: 'https://images.unsplash.com/photo-1557682204-e53b55fd750c?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
    description: 'Durable foam target suitable for both practice and competition.'
  }
];
